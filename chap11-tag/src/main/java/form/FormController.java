...
public class FormController {
    ...
    public String form(Model model, FormCommand formCmd) {
        ...
        List<Code> jobCodes = Arrays.asList(new Code("01", "프로그래머"), new Code("02", "디자이너"));
        model.addAttribute("jobCodes", jobCodes);
        
        model.addAttribute("favoriteOsNames", new String[]{"윈도우8", "윈도우10", "맥OS"});
        model.addAttribute("favoriteOsCodes", Arrays.asList(new Code("01", "윈도우8"), new Code("02", "윈도우10")));
        return "form";
    }
}
